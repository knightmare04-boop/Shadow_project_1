...
\input{sections/01_intro_related}
\input{sections/02_problem_datasets}
\input{sections/03_topology_engine}
\input{sections/04_protocol_ablation}
\input{sections/05_modern_study}
\input{sections/06_synthetic_economy}
\input{sections/07_explainability}
\input{sections/08_system}

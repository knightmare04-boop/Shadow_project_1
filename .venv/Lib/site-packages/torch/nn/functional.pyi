...
# It is standards-track but not in `typing` yet. We leave this here to be uncommented once the feature
# is wide-spread.
...
#
# Functions created via `_add_docstr` in `functional.py` were merely typed as `Any` by `stubgen`, so those were

...
annotated_args = {
    ...
    torch._C._VariableFunctions._philox_key_fold_in: [{'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'data', 'simple_type': 'Tensor'}],
    ...
    torch._C._linalg.linalg_matrix_sqrth: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}],
    ...
    torch._C._linalg.linalg_qr: [{'is_kwarg_only': 'False', 'name': 'A', 'simple_type': 'Tensor'}],
    torch._C._linalg.linalg_polar: [{'is_kwarg_only': 'False', 'name': 'A', 'simple_type': 'Tensor'}],
    torch._C._linalg.linalg_polar: [{'is_kwarg_only': 'False', 'name': 'A', 'simple_type': 'Tensor'}],

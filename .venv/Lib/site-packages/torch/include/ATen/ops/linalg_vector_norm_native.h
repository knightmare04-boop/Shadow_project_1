...
TORCH_API at::Tensor linalg_vector_norm_sparse(const at::Tensor & self, const at::Scalar & ord=2, at::OptionalIntArrayRef dim=::std::nullopt, bool keepdim=false, ::std::optional<at::ScalarType> dtype=::std::nullopt);
} // namespace native
} // namespace at

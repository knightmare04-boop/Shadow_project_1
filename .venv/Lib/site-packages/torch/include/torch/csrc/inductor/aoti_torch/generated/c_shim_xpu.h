...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu__cdist_backward(AtenTensorHandle grad_output, AtenTensorHandle x1, AtenTensorHandle x2, double p, AtenTensorHandle cdist, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu__pdist_backward(AtenTensorHandle grad_output, AtenTensorHandle self, double p, AtenTensorHandle pdist, AtenTensorHandle* ret0);

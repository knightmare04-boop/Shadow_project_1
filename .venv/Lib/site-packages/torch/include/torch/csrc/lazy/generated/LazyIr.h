...
class NativeGroupNorm : public TsNode {
 public:
  static torch::lazy::OpKind ClassOpKind() {
    return torch::lazy::OpKind(at::aten::native_group_norm);
  }

  NativeGroupNorm(const torch::lazy::Value& input, const ::std::optional<torch::lazy::Value>& weight, const ::std::optional<torch::lazy::Value>& bias, const int64_t& N, const int64_t& C, const int64_t& HxW, const int64_t& group, const double& eps, std::vector<torch::lazy::Shape>&& shapes)
      : TsNode(
              NativeGroupNorm::ClassOpKind(),
              OpList{input, weight.value_or(kNullValue), bias.value_or(kNullValue)},
              std::move(shapes),
              /* num_outputs */ 3,
              torch::lazy::MHash(N, C, HxW, group, eps)),
        N(N),
        C(C),
        HxW(HxW),
        group(group),
  ...
  bool CanBeReused(const torch::lazy::Value& input, const ::std::optional<torch::lazy::Value>& weight, const ::std::optional<torch::lazy::Value>& bias, const int64_t& N, const int64_t& C, const int64_t& HxW, const int64_t& group, const double& eps) const {
    size_t i = 0;
    return (operand(i++) == input &&
        nullable_operand(i++) == weight.value_or(kNullValue) &&
        nullable_operand(i++) == bias.value_or(kNullValue) &&
  ...
  torch::lazy::TSOpVector Lower(
    ...
    arguments.emplace_back(has_weight ? loctx->GetOutputOp(operand(i++)) : nullptr);
    arguments.emplace_back(has_bias ? loctx->GetOutputOp(operand(i++)) : nullptr);
    arguments.emplace_back("N", N);
    arguments.emplace_back("C", C);
    arguments.emplace_back("HxW", HxW);
    arguments.emplace_back("group", group);
    arguments.emplace_back("eps", eps);

    torch::lazy::TSOpVector native_group_norm_out = torch::lazy::LowerTSBuiltin(function, op().op, arguments, kwarguments);
    TORCH_CHECK_EQ(native_group_norm_out.size(), 3);

    return native_group_norm_out;
...
class NativeGroupNormBackward : public TsNode {
 public:
  static torch::lazy::OpKind ClassOpKind() {
    return torch::lazy::OpKind(at::aten::native_group_norm_backward);
  }

  NativeGroupNormBackward(const torch::lazy::Value& grad_out, const torch::lazy::Value& input, const torch::lazy::Value& mean, const torch::lazy::Value& rstd, const ::std::optional<torch::lazy::Value>& weight, const int64_t& N, const int64_t& C, const int64_t& HxW, const int64_t& group, const ::std::vector<bool>& output_mask, std::vector<torch::lazy::Shape>&& shapes)
      : TsNode(
              NativeGroupNormBackward::ClassOpKind(),
              OpList{grad_out, input, mean, rstd, weight.value_or(kNullValue)},
              std::move(shapes),
              /* num_outputs */ 3,
              torch::lazy::MHash(N, C, HxW, group, output_mask)),
        N(N),
        C(C),
        HxW(HxW),
        group(group),
  ...
  bool CanBeReused(const torch::lazy::Value& grad_out, const torch::lazy::Value& input, const torch::lazy::Value& mean, const torch::lazy::Value& rstd, const ::std::optional<torch::lazy::Value>& weight, const int64_t& N, const int64_t& C, const int64_t& HxW, const int64_t& group, const ::std::vector<bool>& output_mask) const {
    size_t i = 0;
    return (operand(i++) == grad_out &&
        operand(i++) == input &&
        operand(i++) == mean &&
  ...
  torch::lazy::TSOpVector Lower(
    ...
    torch::lazy::TSOpVector native_group_norm_backward_out = torch::lazy::LowerTSBuiltin(function, op().op, arguments, kwarguments);
    TORCH_CHECK_EQ(native_group_norm_backward_out.size(), 3);

    return native_group_norm_backward_out;
